...
- `interview.md` — quick-reference interview prep questions and answers about the pipeline.
- `parser/` — Lex/Yacc calculator that shows how generated C/C++ files become translation units.
...
For a visual overview of the toolchain, see [`pipeline.md`](pipeline.md). When you're
ready to quiz yourself, jump to the interview questions in [`interview.md`](interview.md).

Want to explore parsing? Head to [`parser/`](parser/README.md) and run `make` to generate a
Flex scanner plus a Bison parser, then feed it arithmetic expressions to see the
translation units produced by code generators.
